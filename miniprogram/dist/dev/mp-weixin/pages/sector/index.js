...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    async function loadData(force) {
      ...
      loading.value = true;
      try {
        const [sectors, flow, globalIndexRows] = await Promise.all([services_api_sector.getSectors(force), services_api_sector.getCapitalFlow(force, 30), services_api_sector.getGlobalIndices()]);
