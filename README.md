...
- 主题基金雷达：按主题检索完整匹配基金池，可区分指数基金与主动混合/股票基金，并显示估值或净值数据来源；航天航空、卫星产业、低空经济和军工国防独立归类。
- 股票行业资金：展示股票行业主力资金热度，不把行业资金复制为单只场外基金申赎数据。
...
- 主题基金页面只有北京时间当日的 `fundgz` 才标记为“当日盘中估值”；回退数据必须标记为“最近净值涨跌”或“历史估值参考”，最终结果以官方净值为准。
- 昨日收益不得用于反推确认金额或持有收益。
